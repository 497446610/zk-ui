...
public class Home extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			logger.error("连接zookeeper失败", ex);
			ServletUtil.INSTANCE.renderError(request, response, "连接zookeeper失败:" + ex.getMessage());
		} catch (InterruptedException | TemplateException ex) {
